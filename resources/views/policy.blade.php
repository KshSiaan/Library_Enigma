<x-base-layout>
    ...
    <div class="container">
        ...
        <div class="px-12 py-4 space-y-3">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Library Enigma.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Library Enigma, accessible from <a href="www.libraryenigma.com"
                            rel="external nofollow noopener" target="_blank">www.libraryenigma.com</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By visiting this page on our website: <a href="www.libraryenigma.com"
                        rel="external nofollow noopener" target="_blank">www.libraryenigma.com</a></li>
            </ul>
        </div>
    </div>
</x-base-layout>
