<x-base-layout>
    ...
    <div class="container">
        ...
        <div class="px-12 py-4 space-y-3">
            ...
            <p>Welcome to Library Enigma!</p>

            <p>These terms and conditions outline the rules and regulations for the use of Library Enigma's Website,
                located at www.libraryenigma.com.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Library
                Enigma if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>We employ the use of cookies. By accessing Library Enigma, you agreed to use cookies in agreement with
                the Library Enigma's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Library Enigma and/or its licensors own the intellectual property rights for all
                material on Library Enigma. All intellectual property rights are reserved. You may access this from
                Library Enigma for your own personal use subjected to restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Library Enigma</li>
                <li>Sell, rent or sub-license material from Library Enigma</li>
                <li>Reproduce, duplicate or copy material from Library Enigma</li>
                <li>Redistribute content from Library Enigma</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Library Enigma does not filter, edit, publish or review Comments prior to
                their presence on the website. Comments do not reflect the views and opinions of Library Enigma,its
                agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, Library Enigma shall not be liable for the
            ...
            <p>Library Enigma reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>You hereby grant Library Enigma a non-exclusive license to use, reproduce, edit and authorize others to
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Library Enigma; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Library Enigma. Please include your name, your
            ...
            <p>No use of Library Enigma's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
